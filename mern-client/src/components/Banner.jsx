...
import BannerCard from '../home/BannerCard'; // Adjust the path if needed
    ...
    <div className = 'px-4 lg:px-24 bg-teal-100 flex items-center'>
        <div className='flex w-full flex-col md:flex-row justify-between items-center gap-12 py-40'>
         ...
         <div className='md:w-1/2 space-y-8 h-full'>
            ...
            <p className ='md:w-4/5'>Discover a world of stories, knowledge, and inspiration! From timeless classics to the latest bestsellers, we offer books for every reader. Step in and let your imagination soar!</p>
            <div>
