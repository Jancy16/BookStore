...
const MyFooter = () => {
  return (
    <Footer bgDark className="bg-gray-800 text-white">
      <div className="w-full px-4 lg:px-24">
        ...
        <div className="w-full bg-gray-700 px-4 py-6 sm:flex sm:items-center sm:justify-between">
          <Footer.Copyright href="#" by="Flowbite™" year={2022} className="text-gray-300" />
          <div className="mt-4 flex space-x-6 sm:mt-0 sm:justify-center">
            ...
            <Footer.Icon href="#" icon={BsTwitter} className="text-gray-300 hover:text-white" />
            <Footer.Icon href="#" icon={BsGithub} className="text-gray-300 hover:text-white" />
          </div>
        </div>
      </div>
    </Footer>
